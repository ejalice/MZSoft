...
struct Story {
    static let story =  [
        Story(type: .success, mainTitle: "성공", subTitle: "", imageName: "stage1_failOne", content: "썸녀가 호감을 보입니다", buttonContent: "다음"),
        ...
        Story(type: .failTwo, mainTitle: "GAME OVER", subTitle: "<이루어질 수 없는 사랑>", imageName: "aliceProfile", content: "너 어디야?..\n오늘 만나기로 했잖아", buttonContent: "홈으로")
    ]
